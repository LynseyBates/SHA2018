...
setwd("P:/SHA/2018/Hermitage2018/Lynsey/Pattern/")

#Read in data for ware, genre and pattern type date ranges
MCDTypeTable<- read.csv('PatternMCDTypes.csv', header=TRUE, stringsAsFactors = F)
...
MCDTypeTable$BeginDate <- as.numeric(MCDTypeTable$BeginDate)
MCDTypeTable$EndDate <- as.numeric(MCDTypeTable$EndDate)
...
wareTypeDataZ<- subset(wareTypeDataB, wareTypeDataB$Ware  %in%  c('Pearlware',
                                                                    'Whiteware',
                                                                    'Porcelain, Chinese'))
...
wareTypeData1$Ware[wareTypeData1$Ware =='Whiteware_Transfer Print Under, pink_Greyhound (TP)'] <- 'Whiteware_TPOther_NoDate'
...
wareTypeData1$Ware[wareTypeData1$Ware =='Whiteware_Transfer Print Under, blue_Wild Rose (TP)'] <- 'Whiteware_Wild Rose (TP)'
wareTypeData1$Ware[wareTypeData1$Ware =='Whiteware_Transfer Print Under, brown_Bouquet (TP)'] <- 'Whiteware_Bouquet (TP)'
wareTypeData1$Ware[wareTypeData1$Ware =='Whiteware_Transfer Print Under, green_Irish Views Series (TP)'] <- 'Whiteware_Irish Views Series (TP)'
wareTypeData1$Ware[wareTypeData1$Ware =='Whiteware_Transfer Print Under, red_Athens (TP)'] <- 'Whiteware_Athens (TP)'
wareTypeData1$Ware[wareTypeData1$Ware =='Whiteware_Transfer Print Under, green_Asiatic Plants (TP)'] <- 'Whiteware_Asiatic Plants (TP)'
wareTypeData1$Ware[wareTypeData1$Ware =='Whiteware_Transfer Print Under, blue_Willow (TP)'] <- 'Whiteware_Willow (TP)'
#wareTypeData1$Ware[wareTypeData1$Ware =='Whiteware_Transfer Print Under, blue_Unidentifiable'] <- 'Whiteware_TPBlue_NoDate'
#wareTypeData1$Ware[wareTypeData1$Ware =='Whiteware_Transfer Print Under, blue_NotApplicable'] <- 'Whiteware_TPBlue_NoDate'


#Pearlware
#wareTypeData1$Ware[wareTypeData1$Ware =='Pearlware_Transfer Print Under, blue_Unidentifiable'] <- 'Pearlware_TPBlue_Unid'
#wareTypeData1$Ware[wareTypeData1$Ware =='Pearlware_Transfer Print Under, brown_Unidentifiable'] <- 'Pearlware_TPBrown_Unid'
wareTypeData1$Ware[wareTypeData1$Ware =='Pearlware_Transfer Print Under, blue_Milkmaid (TP)'] <- 'Pearlware_TPBlue_NoDate'
wareTypeData1$Ware[wareTypeData1$Ware =='Pearlware_Transfer Print Under, blue_Willow (TP)'] <- 'Pearlware_Willow (TP)'
#wareTypeData1$Ware[wareTypeData1$Ware =='Pearlware_Transfer Print Under, black_Unidentifiable'] <- 'Pearlware_TPBrown_Unid'
wareTypeData1$Ware[grepl("^.*Timbered", wareTypeData1$Ware)] <- 'Pearlware_TPBlue_NoDate'
wareTypeData1$Ware[wareTypeData1$Ware =='Whiteware_Transfer Print Under, blue_Fishermen with Nets (TP)'] <- 'Pearlware_Fishermen with Nets (TP)'
wareTypeData1$Ware[wareTypeData1$Ware =='Pearlware_Transfer Print Under, blue_Fishermen with Nets (TP)'] <- 'Pearlware_Fishermen with Nets (TP)'
...
wareTypeData1$Ware[wareTypeData1$Ware =='Pearlware_Transfer Print Under, blue_"Framed Hunting Scene" (TP)'] <- 'Pearlware_Transylvania University (TP)'
...
wareTypeData1$Ware[grepl("^.*Beauties", wareTypeData1$Ware)] <- 'Pearlware_Beauties of America Series (TP)'
wareTypeData1$Ware[wareTypeData1$Ware =='Pearlware_Transfer Print Under, blue_Transylvania University (TP)'] <- 'Pearlware_Transylvania University (TP)'
wareTypeData1$Ware[wareTypeData1$Ware =='Pearlware_Transfer Print Under, blue_Wild Rose (TP)'] <- 'Pearlware_Wild Rose (TP)'
wareTypeData1$Ware[wareTypeData1$Ware =='Pearlware_Transfer Print Under, brown_Ornate Pagodas (TP)'] <- 'Pearlware_Ornate Pagodas (TP)'


#Chinese Porcelain
wareTypeData1$Ware[wareTypeData1$Ware =='Porcelain, Chinese_Handpainted Blue_Canton (HP)'] <- 'Porcelain, Chinese_Canton'
wareTypeData1$Ware[wareTypeData1$Ware =='Porcelain, Chinese_Handpainted Blue_Nanking (HP)'] <- 'Porcelain, Chinese_Nanking'


#EXCLUDE
wareTypeData1$Ware[grepl("^.*Whiteware_F", wareTypeData1$Ware)] <- 'EXC'
wareTypeData1$Ware[grepl("^.*Whiteware_S", wareTypeData1$Ware)] <- 'EXC'
wareTypeData1$Ware[grepl("^.*Whiteware_H", wareTypeData1$Ware)] <- 'EXC'
wareTypeData1$Ware[grepl("^.*Whiteware_L", wareTypeData1$Ware)] <- 'EXC'
wareTypeData1$Ware[grepl("^.*Pearlware_F", wareTypeData1$Ware)] <- 'EXC'
wareTypeData1$Ware[grepl("^.*Pearlware_S", wareTypeData1$Ware)] <- 'EXC'
wareTypeData1$Ware[grepl("^.*Pearlware_H", wareTypeData1$Ware)] <- 'EXC'
wareTypeData1$Ware[grepl("^.*Pearlware_L", wareTypeData1$Ware)] <- 'EXC'
wareTypeData1$Ware[grepl("^.*Pearlware_M", wareTypeData1$Ware)] <- 'EXC'
wareTypeData1$Ware[grepl("^.*Whiteware_M", wareTypeData1$Ware)] <- 'EXC'
wareTypeData1$Ware[grepl("^.*Whiteware_O", wareTypeData1$Ware)] <- 'EXC'
wareTypeData1$Ware[wareTypeData1$Ware =='Porcelain, Chinese_Overglaze, handpainted_Not Applicable'] <- 'EXC'
wareTypeData1$Ware[wareTypeData1$Ware =='Porcelain, Chinese_Handpainted Blue_Not Applicable'] <- 'EXC'
wareTypeData1$Ware[wareTypeData1$Ware =='Porcelain, Chinese_Handpainted Blue_Unidentifiable'] <- 'EXC'
wareTypeData1$Ware[wareTypeData1$Ware =='Whiteware_Transfer Print Under, unidentifiable_Not Applicable'] <- 'EXC'
wareTypeData1$Ware[wareTypeData1$Ware =='Pearlware_Transfer Print Under, unidentifiable_Not Applicable'] <- 'EXC'
wareTypeData1$Ware[wareTypeData1$Ware =='Whiteware_Transfer Print Under, unidentifiable_Unidentifiable'] <- 'EXC'
wareTypeData1$Ware[wareTypeData1$Ware =='Pearlware_Transfer Print Under, unidentifiable_Unidentifiable'] <- 'EXC'
wareTypeData1$Ware[wareTypeData1$Ware =='Whiteware_Transfer Print Under, blue_Unidentifiable'] <- 'EXC'
wareTypeData1$Ware[wareTypeData1$Ware =='Whiteware_Transfer Print Under, blue_NotApplicable'] <- 'EXC'
wareTypeData1$Ware[wareTypeData1$Ware =='Pearlware_Transfer Print Under, blue_Unidentifiable'] <- 'EXC'
wareTypeData1$Ware[wareTypeData1$Ware =='Pearlware_Transfer Print Under, brown_Unidentifiable'] <- 'EXC'
wareTypeData1$Ware[wareTypeData1$Ware =='Pearlware_Transfer Print Under, black_Unidentifiable'] <- 'EXC'
wareTypeData1$Ware[wareTypeData1$Ware =='Whiteware_Transfer Print Under, red_Unidentifiable'] <- 'Whiteware_TPOther_Unid'
wareTypeData1$Ware[wareTypeData1$Ware =='Whiteware_Transfer Print Under, black_Unidentifiable'] <- 'Whiteware_TPOther_Unid'
wareTypeData1$Ware[wareTypeData1$Ware =='Whiteware_Transfer Print Under, brown_Unidentifiable'] <- 'Whiteware_TPOther_Unid'
wareTypeData1$Ware[wareTypeData1$Ware =='Whiteware_Transfer Print Under, gray_Unidentifiable'] <- 'Whiteware_TPOther_Unid'
wareTypeData1$Ware[wareTypeData1$Ware =='Whiteware_Transfer Print Under, green_Unidentifiable'] <- 'Whiteware_TPOther_Unid'
wareTypeData1$Ware[wareTypeData1$Ware =='Whiteware_Transfer Print Under, light blue_Unidentifiable'] <- 'Whiteware_TPOther_Unid'
wareTypeData1$Ware[wareTypeData1$Ware =='Whiteware_Transfer Print Under, pink_Unidentifiable'] <- 'Whiteware_TPOther_Unid'
wareTypeData1$Ware[wareTypeData1$Ware =='Whiteware_Transfer Print Under, polychrome_Unidentifiable'] <- 'Whiteware_TPOther_Unid'
wareTypeData1$Ware[wareTypeData1$Ware =='Whiteware_Transfer Print Under, purple_Unidentifiable'] <- 'Whiteware_TPOther_Unid'
wareTypeData1$Ware[wareTypeData1$Ware =='Whiteware_Transfer Print Under, black_Not Applicable'] <- 'Whiteware_TPOther_Unid'
wareTypeData1$Ware[wareTypeData1$Ware =='Whiteware_Transfer Print Under, brown_Not Applicable'] <- 'Whiteware_TPOther_Unid'
wareTypeData1$Ware[wareTypeData1$Ware =='Whiteware_Transfer Print Under, green_Not Applicable'] <- 'Whiteware_TPOther_Unid'
wareTypeData1$Ware[wareTypeData1$Ware =='Whiteware_Transfer Print Under, red_Not Applicable'] <- 'Whiteware_TPOther_Unid'
wareTypeData1$Ware[wareTypeData1$Ware =='Whiteware_Transfer Print Under, purple_Not Applicable'] <- 'Whiteware_TPOther_Unid'
...
wareTypeData2<- subset(wareTypeData1, ! wareTypeData1$Ware  %in%  c('Whiteware_Transfer Print Under, blue_Not Applicable',
                                                                    'EXC',            
                                                                    'Whiteware_TPOther_Unid',
                                                                    'Whiteware_Bouquet (TP)',
                                                                    'Pearlware_TPBlue_NoDate',
                                                                    'Whiteware_TPBlue_NoDate',
                                                                    'Whiteware_TPOther_NoDate',
                                                                    'Whiteware_TPOther_Unid'))
...
#Remove context outliers
#WareByUnitTOut <-subset(WareByUnitT1, !WareByUnitT1$unit %in% c('WC_SG02'))
#                                                               'EC_98-01-017',
#                                                              'WC_730','WC_718',
...
#WareByUnitT2<-WareByUnitT1[, colSums(WareByUnitT1 != 0) > 5]
...
#     unitData dataframe.  
# Code needs to be fixed so that types NOT in MCDTypeTable are flagged somehow
...
rowscores <- data.frame(ca3$rowcoord[,1], ca3$rowcoord[,2], ca3$rowcoord[,3])
colnames(rowscores) <- c("Dim1", "Dim2", "Dim3")
...
p1
#ggsave("CApattern_EastWest_Dim1Dim2_datesonly.png", p1, width=10, height=7.5, dpi=300)

p1a <- ggplot(rowscores, aes(x=rowscores$Dim2,y=rowscores$Dim3))+
  geom_point(shape=21, size=5, colour="black", fill="cornflower blue")+
  #geom_text(aes(label=rownames(rowscores)),vjust=-.6, hjust=-.1, cex=5)+
  #  xlim(-4,4)+
  geom_text_repel(aes(label=rownames(rowscores)), cex=5, segment.alpha=0.2) +
  theme_classic()+
  labs(title="East and West Cabin", x="Dimension 2", y="Dimension 3")+
  theme(plot.title=element_text(size=rel(2), hjust=0.5),axis.title=element_text(size=rel(1.75)),
        axis.text=element_text(size=rel(1.5)))
p1a
#ggsave("CApattern_EastWest_Dim2Dim3_Datesonly.png", p1a, width=10, height=7.5, dpi=300)
...
p2 <- ggplot(colscores, aes(x=colscores$Dim1,y=colscores$Dim2))+
  ...
  theme(plot.title=element_text(size=rel(2.25), hjust=0.5),axis.title=element_text(size=rel(1.75)),
        axis.text=element_text(size=rel(1.5)))
p2
#ggsave("CApattern_EastWest_Dim1Dim2types_datesonly.png", p2, width=10, height=7.5, dpi=300)
...
p3 <- ggplot(rowscores, aes(x=rowscores$Dim1,y=MCDByUnit$MCDs$blueMCD))+
  ...
  theme(plot.title=element_text(size=rel(2.25), hjust=0.5),axis.title=element_text(size=rel(1.75)),
        axis.text=element_text(size=rel(1.5)))
p3
#ggsave("CApattern_EastWest_Dim1BLUEMCD.png", p3, width=10, height=7.5, dpi=300)
#ggsave("CApattern_EastWest_Dim1BLUEMCD_datesonly.png", p3, width=10, height=7.5, dpi=300)

#Create plot: Dim 2 and BLUE MCD
p3a <- ggplot(rowscores, aes(x=rowscores$Dim2,y=MCDByUnit$MCDs$blueMCD))+
  geom_point(shape=21, size=5, colour="black", fill="cornflower blue")+
  #geom_text(aes(label=rownames(rowscores)),vjust=-.6, hjust=-.1, cex=5)+
  geom_text_repel(aes(label=rownames(rowscores)), cex=5, segment.alpha=0.2) +
  theme_classic()+
  labs(title="East and West Cabin", x="Dimension 2", y="BLUE MCD")+
  theme(plot.title=element_text(size=rel(2.25), hjust=0.5),axis.title=element_text(size=rel(1.75)),
        axis.text=element_text(size=rel(1.5)))
p3a
#ggsave("CApattern_EastWest_Dim2BLUEMCD_datesonly.png", p3a, width=10, height=7.5, dpi=300)
...
color
#ggsave("CApattern_EastWest_D1BMCD_labelsdatesonly.png", color, width=10, height=7.5, dpi=300)
...
#p5a <- p5 + geom_vline(xintercept=c(-1.1, -0.6, 0.3, 0.6, 1.1))
#p5a
#ggsave("CApattern_EastWest_Hist_Datesonly.png", p5, width=10, height=7.5, dpi=300)
#ggsave("CAdec_EastWest_Hist_lines.png", p5a, width=10, height=7.5, dpi=300)

CA_MCD1 <- CA_MCD[order(CA_MCD$blueMCD),]

write.csv(CA_MCD1, file="CApattern_results.csv")
...
Phase[(ca3$rowcoord[,1] > -3) & (ca3$rowcoord[,1]) <= -1.8] <- 'P02'
Phase[(ca3$rowcoord[,1] > -1.8) & (ca3$rowcoord[,1]) <= -0.5] <- 'P03'
Phase[(ca3$rowcoord[,1] > -0.5) & (ca3$rowcoord[,1]) <= 0.6] <- 'P04'
Phase[(ca3$rowcoord[,1] > 0.6) & (ca3$rowcoord[,1]) <= 1.1] <- 'P05'
...
#Check ware by phase
WareByPhase <- WareByPhase[,-c(46:50)]